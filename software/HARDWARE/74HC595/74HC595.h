...
#define RCC_HC595_PORT 	RCC_APB2Periph_GPIOB
#define HC595_PORT		GPIOB

#define HC595_CLK  PBout(4)//S_CLK_Pin12_SHCP_OUT 	
#define HC595_SCK  PBout(5)//R_CLK_Pin13_STCP_OUT	 
#define HC595_DAT  PBout(3)//MOSIO_Pin14_DS_OUT
#define HC595_OE   PAout(8)
